...
namespace WhiteLabel.Domain.Pagination
{
    ...
    public interface IQueryableEvaluator
    {
        ...
        int Count<T>(IQueryable<T> source)
            where T : class;
        ...
        bool Any<T>(IQueryable<T> source)
            where T : class;
        ...
        T FirstOrDefault<T>(IQueryable<T> source)
            where T : class;
        ...
        T SingleOrDefault<T>(IQueryable<T> source)
            where T : class;
        ...
        T[] ToArray<T>(IQueryable<T> source)
            where T : class;
